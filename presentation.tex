...
\begin{frame}{QEC general idea}
	...
	\begin{minipage}[t]{0.3\textwidth}
		\vspace{-1.5cm}
        \includegraphics[width=0.6\textwidth]{fig/Rotated_surface_code_d3.png}
    \end{minipage}
	\pause
...
\begin{frame}{Example: Surface Code}
	\begin{textblock*}{7cm}(1.5cm,2cm)
		\includegraphics[width=0.55\textwidth]{fig/Rotated_surface_code_d3.png}
	\end{textblock*}
	\only<1-1>{
		\begin{textblock*}{7cm}(8.5cm,2.5cm)
			\begin{itemize}
				\item \cite{kitaev_fault-tolerant_2003, bombin_optimal_2007}
