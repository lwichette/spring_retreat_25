...
\begin{frame}{Gap}
	Existing:
	\begin{itemize}
		\item Much effort in development of error correcting codes
		\item Quality markers of codes: Density of logical qubits per physical, code distance, $p_{\text{threshold}}$
