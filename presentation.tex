...
\begin{frame}{Surface Code Suboptimal Decoders}
	...
	\begin{textblock*}{5.8cm}(0.1cm,3.5cm)
		...
		\begin{itemize}
			...
			\item Noise informed reweighting \cite{higgott_improved_2023}
		\end{itemize}
		\end{small}
	\end{textblock*}
	}
	...
	\begin{textblock*}{6cm}(0.1cm,3cm)
		\begin{small}
			...
			\begin{itemize}
				...
				\item Fast implementations for realtime decoding: Sparse blossom $O(N^{1.32})$, fusion blossom $O(N^{1.32})$
				\item Noise informed reweighting \cite{iolius_performance_2022}
			\end{itemize}
		\end{small}
	\end{textblock*}
	...
	\begin{textblock*}{6cm}(0.1cm,3cm)
		\begin{small}
			...
			\begin{itemize}
				\item Surface codes admit natural tensor network representation
				\item
			\end{itemize}
		\end{small}
	\end{textblock*}
