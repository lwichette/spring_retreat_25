...
\begin{frame}{Example: Surface Code}
	...
	\only<2-2>{
		...
		\begin{textblock*}{10cm}(6cm,3.5cm)
			\textbf{Maximum Probability/Minimum Weight Perfect Matching Decoder:}\\
...
\begin{frame}{Scaling the system size}
	...
	\only<2-2>{
		\begin{textblock*}{6cm}(8cm,5.5cm)
			Existence proofs of thresholds have been established for various code families \citeauthoryear{kitaev_fault-tolerant_2003}.
		\end{textblock*}
	}
\end{frame}
...
\begin{frame}{Suboptimal vs Optimal Decoding}
	\begin{textblock*}{10cm}(1.5cm,2cm)
		\includegraphics[width=0.55\textwidth]{fig/threshold.png}
	\end{textblock*}
	\begin{textblock*}{10cm}(8.5cm,2cm)
		\includegraphics[width=0.55\textwidth]{fig/optimal_threshold.png}
	\end{textblock*}
	\vspace{4.5cm}
	\begin{itemize}
		\item \textbf{Suboptimal decoders:} Performance estimates for varying sizes and error rates
		\item \textbf{Optimal decoder:} Mainly estimation of error threshold
	\end{itemize}
\end{frame}
...
\begin{frame}{Results - Expectation of dMP}
	degenracies in ground states of toric code of even dim
\end{frame}
...
\begin{frame}{Results - Enhanced Pymatching}
	\begin{figure}[h!]
		...
		\end{minipage}
	\end{figure}
	\textcolor{red}{get plots of larger permutations/perturbations}
\end{frame}
