...
\begin{frame}{Overview Optimal Performance Estimation}
	\begin{itemize}
		\item Previously: Introduced logical failure curves as quality metric for suboptimal decoders
		\pause
...
\begin{frame}{Optimal Code Performance}
	...
	\begin{textblock*}{8cm}(0.5cm,3cm)
		\begin{itemize}
			\item Optimal decoding is NP-hard~\citeauthoryear{hsieh_np-hardness_2011}
...
\begin{frame}{Overview Results}
	\begin{itemize}
		\item Developed code and noise adaptive framework for optimal code performance estimation
