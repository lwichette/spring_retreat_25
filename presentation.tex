...
\begin{frame}{Overview Literature Research}
	\begin{center}
		\begin{itemize}
			...
			\pause
			\only<2->{
			\item Codes and used quality markers
			\vspace{0.5cm}
			\item Decoder and used quality markers
			}
			\vspace{0.5cm}
			\pause
			\only<3->{
...
\begin{frame}{Gap}
	...
	Laking:
	\begin{itemize}
		\item Comparibility of codes for finite size regime under realistic noise models by optimal code capacity estimates
...
\begin{frame}{Conclusion and Outlook}
	...
	\begin{itemize}
		...
		\item \textbf{Decoder Optimization:} MWPM decoder can be enhanced by degeneracy of ground states
		\item \textbf{Near future:} TN implementation
		\item \textbf{Further:} More realistic noise model
	\end{itemize}
\end{frame}
